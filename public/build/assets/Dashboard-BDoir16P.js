import{J as j,r as N,j as e,Q as w}from"./app-DZ2M8FXv.js";import{A as y}from"./AuthenticatedLayout-DDiQP-0w.js";import{S as k}from"./SalesModal-CBDRPRhx.js";import{R as F}from"./RankingDisplay-Cw8HYELR.js";import{f as r}from"./currency-nnCpYJTe.js";/* empty css            */import"./transition-Bd4I4T1S.js";import"./x-EywRUog-.js";import"./createLucideIcon-wuN8DPg_.js";function P(){var m;const{auth:l,gamification:a,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
