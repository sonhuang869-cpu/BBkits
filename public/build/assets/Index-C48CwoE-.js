import{J as C,r,j as e,Q as V}from"./app-3Q_HVbIJ.js";import{A as k}from"./AuthenticatedLayout-B1ZmwDtj.js";import{S as E}from"./SalesModal-D1ntLzsV.js";/* empty css            */import"./transition-BF6Jukzv.js";import"./x-CddQK3jj.js";import"./createLucideIcon-BoJKjBqo.js";function $({salesData:i,commissionData:A,totalStats:a}){const{auth:R}=C().props,[c,h]=r.useState(new Date().getMonth()+1),[x,g]=r.useState(new Date().getFullYear()),[b,m]=r.useState(!1),[o,u]=r.useState(null),[f,j]=r.useState([]),t=s=>new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(s),v=s=>s>=6e4?{level:"Elite",color:"bg-gradient-to-r from-purple-500 to-pink-500",icon:"👑"}:s>=5e4?{level:"Avançada",color:"bg-gradient-to-r from-blue-500 to-cyan-500",icon:"🏆"}:s>=4e4?{level:"Intermediária",color:"bg-gradient-to-r from-green-500 to-emerald-500",icon:"⭐"}:{level:"Iniciante",color:"bg-gradient-to-r from-gray-400 to-gray-600",icon:"🌟"},N=[{value:1,label:"Janeiro"},{value:2,label:"Fevereiro"},{value:3,label:"Março"},{value:4,label:"Abril"},{value:5,label:"Maio"},{value:6,label:"Junho"},{value:7,label:"Julho"},{value:8,label:"Agosto"},{value:9,label:"Setembro"},{value:10,label:"Outubro"},{value:11,label:"Novembro"},{value:12,label:"Dezembro"}],w=new Date().getFullYear(),y=Array.from({length:3},(s,n)=>w-n),l=s=>{const n=`/admin/export/${s}?month=${c}&year=${x}`;window.open(n,"_blank")},F=async s=>{u(s),j(s.sales||[]),m(!0)};return e.jsxs(e.Fragment,{children:[e.jsx(V,{title:"Relatórios de Vendas e Comissões - BBKits"}),e.jsx("style",{children:`
