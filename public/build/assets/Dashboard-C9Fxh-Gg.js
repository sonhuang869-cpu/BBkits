import{J as j,r as N,j as e,Q as w}from"./app-D9GhqWyc.js";import{A as y}from"./AuthenticatedLayout-CxFJG2o-.js";import{S as k}from"./SalesModal-CVX_C5UC.js";import{R as F}from"./RankingDisplay-DmCpopgB.js";import{f as r}from"./currency-nnCpYJTe.js";/* empty css            */import"./transition-De_m7Z0f.js";import"./x-C3CmZQYT.js";import"./createLucideIcon-BjKOtmC7.js";function P(){var m;const{auth:l,gamification:a,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
