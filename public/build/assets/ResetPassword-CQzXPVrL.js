import{x as h,j as e,Q as f,d as i,V as l}from"./app-CkklZgaI.js";import"./TextInput-BxJb0pze.js";/* empty css            */function j({token:d,email:c}){const{data:r,setData:t,post:m,processing:o,errors:s,reset:x}=h({token:d,email:c,password:"",password_confirmation:""}),p=a=>{a.preventDefault(),m(route("password.store"),{onFinish:()=>x("password","password_confirmation"),onSuccess:()=>{l.success("Senha redefinida com sucesso!")},onError:n=>{Object.keys(n).forEach(u=>{l.error(n[u])})}})};return e.jsxs(e.Fragment,{children:[e.jsx(f,{title:"Redefinir Senha - BBKits"}),e.jsx("style",{children:`
