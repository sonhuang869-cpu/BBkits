import{j as e,r as l,x as b}from"./app-Dj7VubCJ.js";import{M as w,I as v}from"./InputLabel-ut6aY4Yy.js";import{T as y}from"./TextInput-DZKpIS51.js";/* empty css            */import"./dialog-Ctb6omh5.js";import"./transition-CYfzwLac.js";function j({message:a,className:s="",...r}){return a?e.jsx("p",{...r,className:"text-sm text-red-600 "+s,children:a}):null}function I({className:a=""}){const[s,r]=l.useState(!1),n=l.useRef(),{data:c,setData:m,delete:x,processing:i,reset:d,errors:p,clearErrors:u}=b({password:""}),h=()=>{r(!0)},g=t=>{t.preventDefault(),x(route("profile.destroy"),{preserveScroll:!0,onSuccess:()=>o(),onError:()=>n.current.focus(),onFinish:()=>d()})},o=()=>{r(!1),u(),d()};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
