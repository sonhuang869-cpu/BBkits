import{r as i,j as e,t as d,a as f,J as N}from"./app-DVNfJ7xh.js";import{z as M}from"./transition-tC14V518.js";const b=i.createContext(),m=({children:a})=>{const[n,r]=i.useState(!1),o=()=>{r(s=>!s)};return e.jsx(b.Provider,{value:{open:n,setOpen:r,toggleOpen:o},children:e.jsx("div",{className:"relative",children:a})})},L=({children:a})=>{const{open:n,setOpen:r,toggleOpen:o}=i.useContext(b);return e.jsxs(e.Fragment,{children:[e.jsx("div",{onClick:o,children:a}),n&&e.jsx("div",{className:"fixed inset-0 z-40",onClick:()=>r(!1)})]})},C=({align:a="right",width:n="48",contentClasses:r="py-1 bg-white",children:o})=>{const{open:s,setOpen:x}=i.useContext(b);let c="origin-top";a==="left"?c="ltr:origin-top-left rtl:origin-top-right start-0":a==="right"&&(c="ltr:origin-top-right rtl:origin-top-left end-0");let h="";return n==="48"&&(h="w-48"),e.jsx(e.Fragment,{children:e.jsx(M,{show:s,enter:"transition ease-out duration-200",enterFrom:"opacity-0 scale-95",enterTo:"opacity-100 scale-100",leave:"transition ease-in duration-75",leaveFrom:"opacity-100 scale-100",leaveTo:"opacity-0 scale-95",children:e.jsx("div",{className:`absolute z-50 mt-2 rounded-md shadow-lg ${c} ${h}`,onClick:()=>x(!1),children:e.jsx("div",{className:"rounded-md ring-1 ring-black ring-opacity-5 "+r,children:o})})})})},z=({className:a="",children:n,...r})=>e.jsx(d,{...r,className:"block w-full px-4 py-2 text-start text-sm leading-5 text-gray-700 transition duration-150 ease-in-out hover:bg-gray-100 focus:bg-gray-100 focus:outline-none "+a,children:n});m.Trigger=L;m.Content=C;m.Link=z;function j({trigger:a,children:n,className:r=""}){const[o,s]=i.useState(!1);return e.jsxs("div",{className:"relative inline-block text-left",children:[e.jsx("div",{children:e.jsx("button",{type:"button",className:"nav-link flex items-center gap-0.5 lg:gap-1 xl:gap-2",onMouseEnter:()=>s(!0),onMouseLeave:()=>s(!1),onClick:()=>s(!o),children:a})}),o&&e.jsx("div",{className:`absolute right-0 z-50 mt-0.5 w-56 origin-top-right rounded-xl bg-white shadow-xl ring-1 ring-gray-200 focus:outline-none dropdown-menu ${r}`,onMouseEnter:()=>s(!0),onMouseLeave:()=>s(!1),style:{marginTop:"2px"},children:e.jsx("div",{className:"py-1",children:n})})]})}function v({active:a=!1,className:n="",children:r,...o}){return e.jsx(d,{...o,className:"inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium leading-5 transition duration-150 ease-in-out focus:outline-none "+(a?"border-indigo-400 text-gray-900 focus:border-indigo-700":"border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 focus:border-gray-300 focus:text-gray-700")+n,children:r})}function l({active:a=!1,className:n="",children:r,...o}){return e.jsx(d,{...o,className:`flex w-full items-start border-l-4 py-2 pe-4 ps-3 ${a?"border-indigo-400 bg-indigo-50 text-indigo-700 focus:border-indigo-700 focus:bg-indigo-100 focus:text-indigo-800":"border-transparent text-gray-600 hover:border-gray-300 hover:bg-gray-50 hover:text-gray-800 focus:border-gray-300 focus:bg-gray-50 focus:text-gray-800"} text-base font-medium transition duration-150 ease-in-out focus:outline-none ${n}`,children:r})}function B({title:a,titleId:n,...r},o){return i.createElement("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:1.5,stroke:"currentColor","aria-hidden":"true","data-slot":"icon",ref:o,"aria-labelledby":n},r),a?i.createElement("title",{id:n},a):null,i.createElement("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0"}))}const k=i.forwardRef(B);function V({title:a,titleId:n,...r},o){return i.createElement("svg",Object.assign({xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":"true","data-slot":"icon",ref:o,"aria-labelledby":n},r),a?i.createElement("title",{id:n},a):null,i.createElement("path",{fillRule:"evenodd",d:"M5.25 9a6.75 6.75 0 0 1 13.5 0v.75c0 2.123.8 4.057 2.118 5.52a.75.75 0 0 1-.297 1.206c-1.544.57-3.16.99-4.831 1.243a3.75 3.75 0 1 1-7.48 0 24.585 24.585 0 0 1-4.831-1.244.75.75 0 0 1-.298-1.205A8.217 8.217 0 0 0 5.25 9.75V9Zm4.502 8.9a2.25 2.25 0 1 0 4.496 0 25.057 25.057 0 0 1-4.496 0Z",clipRule:"evenodd"}))}const H=i.forwardRef(V);function F(){const[a,n]=i.useState(0),[r,o]=i.useState([]),[s,x]=i.useState(!1);i.useEffect(()=>{c();const t=setInterval(c,3e4);return()=>clearInterval(t)},[]);const c=async()=>{try{const t=await f.get("/notifications/unread-count",{headers:{Accept:"application/json","X-Requested-With":"XMLHttpRequest"}});n(t.data.count)}catch{n(0)}},h=async()=>{try{const t=await f.get("/notifications",{headers:{Accept:"application/json","X-Requested-With":"XMLHttpRequest"}});o(t.data.notifications||[])}catch{o([])}},g=async t=>{try{await f.post(`/notifications/${t}/read`,{},{headers:{Accept:"application/json","X-Requested-With":"XMLHttpRequest"}}),c(),h()}catch{}},u=async()=>{try{await f.post("/notifications/mark-all-read",{},{headers:{Accept:"application/json","X-Requested-With":"XMLHttpRequest"}}),n(0),h()}catch{}},p=()=>{x(!s),s||h()},w=t=>{switch(t){case"sale_approved":return"✅";case"sale_rejected":return"❌";case"new_sale":return"📋";case"goal_reached":return"🎯";default:return"📢"}},y=t=>{switch(t){case"sale_approved":return"bg-green-100 text-green-800";case"sale_rejected":return"bg-red-100 text-red-800";case"new_sale":return"bg-blue-100 text-blue-800";case"goal_reached":return"bg-yellow-100 text-yellow-800";default:return"bg-gray-100 text-gray-800"}};return e.jsxs("div",{className:"relative",children:[e.jsxs("button",{onClick:p,className:"relative p-2 rounded-full hover:bg-gray-100 transition-colors duration-200",children:[a>0?e.jsx(H,{className:"h-6 w-6 text-pink-600"}):e.jsx(k,{className:"h-6 w-6 text-gray-600"}),a>0&&e.jsx("span",{className:"absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white bg-gradient-to-r from-pink-500 to-purple-500 rounded-full transform translate-x-1/2 -translate-y-1/2",children:a>9?"9+":a})]}),s&&e.jsxs("div",{className:"absolute right-0 mt-2 w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 z-50 overflow-hidden",children:[e.jsx("div",{className:"bg-gradient-to-r from-pink-50 to-purple-50 px-4 py-3 border-b border-gray-100",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("h3",{className:"text-lg font-semibold text-gray-800",children:"Notificações"}),a>0&&e.jsx("button",{onClick:u,className:"text-sm text-pink-600 hover:text-pink-800 font-medium",children:"Marcar todas como lidas"})]})}),e.jsx("div",{className:"max-h-96 overflow-y-auto",children:r.length>0?r.map(t=>e.jsx("div",{className:`px-4 py-3 border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200 ${t.read?"":"bg-pink-50"}`,onClick:()=>!t.read&&g(t.id),children:e.jsxs("div",{className:"flex items-start space-x-3",children:[e.jsx("div",{className:`p-2 rounded-full ${y(t.type)}`,children:e.jsx("span",{className:"text-lg",children:w(t.type)})}),e.jsxs("div",{className:"flex-1",children:[e.jsx("p",{className:"text-sm text-gray-800",children:t.message}),e.jsx("p",{className:"text-xs text-gray-500 mt-1",children:new Date(t.created_at).toLocaleString("pt-BR")})]}),!t.read&&e.jsx("div",{className:"w-2 h-2 bg-pink-500 rounded-full mt-2"})]})},t.id)):e.jsxs("div",{className:"px-4 py-8 text-center",children:[e.jsx("div",{className:"w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-3",children:e.jsx(k,{className:"h-8 w-8 text-gray-400"})}),e.jsx("p",{className:"text-gray-500",children:"Nenhuma notificação no momento"})]})}),r.length>0&&e.jsx("div",{className:"px-4 py-3 bg-gray-50 border-t border-gray-100",children:e.jsx("a",{href:"/notifications",className:"text-sm text-pink-600 hover:text-pink-800 font-medium block text-center",children:"Ver todas as notificações"})})]}),s&&e.jsx("div",{className:"fixed inset-0 z-40",onClick:()=>x(!1)})]})}function R({header:a,children:n}){const r=N().props.auth.user,[o,s]=i.useState(!1),[x,c]=i.useState(!1),h=()=>["admin","manager","production_admin","finance_admin","financeiro"].includes(r.role),g=()=>["admin","manager","production_admin","finance_admin","financeiro"].includes(r.role),u=()=>["admin","manager","production_admin","finance_admin","financeiro"].includes(r.role);return i.useEffect(()=>{const p=()=>{c(window.scrollY>50)};return window.addEventListener("scroll",p),()=>window.removeEventListener("scroll",p)},[]),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
