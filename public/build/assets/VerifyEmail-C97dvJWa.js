import{x as n,r as d,V as a,j as e,Q as c,d as i}from"./app-CkklZgaI.js";/* empty css            */function p({status:r}){const{post:t,processing:s}=n({});d.useEffect(()=>{r==="verification-link-sent"&&a.success("Novo link de verificação enviado!")},[r]);const l=o=>{o.preventDefault(),t(route("verification.send"),{onSuccess:()=>{a.success("Link de verificação reenviado com sucesso!")},onError:()=>{a.error("Erro ao enviar link de verificação. Tente novamente.")}})};return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"Verificar E-mail - BBKits"}),e.jsx("style",{children:`
