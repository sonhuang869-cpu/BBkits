import{J as h,r as p,j as e,Q as g}from"./app-BsOR1-Zn.js";import{A as b}from"./AuthenticatedLayout-Ddz-8J84.js";import{S as u}from"./SalesModal-BrDlmzU0.js";import{R as f}from"./RankingDisplay-Dm178U0M.js";/* empty css            */import"./transition-BnUKp_Ar.js";import"./x-CHbSuwkU.js";import"./createLucideIcon-Dh6cifh7.js";const s=l=>{const r=parseFloat(l)||0;return new Intl.NumberFormat("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}).format(r)};function C(){var o;const{auth:l,gamification:r,salesData:t,recentSales:n,allMonthlySales:c}=h().props,[m,d]=p.useState(!1),x=()=>{d(!0)};return console.log("Dashboard Props:",{salesData:t,recentSales:n}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
