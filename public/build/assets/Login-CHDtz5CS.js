import{x as g,r as u,V as s,j as e,Q as h,d as l}from"./app-Kvj5QWOj.js";import"./TextInput-CdXMkY2z.js";/* empty css            */function j({status:o,canResetPassword:d}){const{data:i,setData:n,post:m,processing:c,errors:r,reset:x}=g({email:"",password:"",remember:!1});u.useEffect(()=>{o&&s.success(o)},[o]);const p=a=>{a.preventDefault(),m("/login",{onFinish:()=>x("password"),onSuccess:()=>{s.success("Login realizado com sucesso!")},onError:t=>{t.email&&s.error(t.email),t.password&&s.error(t.password)}})};return e.jsxs(e.Fragment,{children:[e.jsx(h,{title:"Entrar - BBKits"}),e.jsx("style",{children:`
