import{J as h,r as p,j as e,Q as g}from"./app-CXNzgq3A.js";import{A as b}from"./AuthenticatedLayout-Dk0MUoZD.js";import{S as u}from"./SalesModal-B6OdkSyI.js";import{R as f}from"./RankingDisplay-pSW1LRqn.js";/* empty css            */import"./transition-DNYrCjPY.js";import"./x-DDtA5rKv.js";import"./createLucideIcon-DYs5cDha.js";const s=l=>{const r=parseFloat(l)||0;return new Intl.NumberFormat("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}).format(r)};function C(){var o;const{auth:l,gamification:r,salesData:t,recentSales:n,allMonthlySales:c}=h().props,[m,d]=p.useState(!1),x=()=>{d(!0)};return console.log("Dashboard Props:",{salesData:t,recentSales:n}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
