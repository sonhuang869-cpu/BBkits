import{J as g,r as b,j as e,Q as f}from"./app-CueGs5Xu.js";import{A as u}from"./AuthenticatedLayout-DuHQyuAv.js";import{S as v}from"./SalesModal-7SNkB9BR.js";import{R as m}from"./RankingDisplay-CpuwBnwF.js";import{f as t}from"./currency-Ct0iAvPU.js";/* empty css            */import"./transition-DA3C8QnC.js";import"./x-hGthCMqR.js";import"./createLucideIcon-BpvUb0UH.js";function B(){var c;const{auth:l,gamification:a,salesData:s,recentSales:i,allMonthlySales:x,topPerformers:d}=g().props,[h,o]=b.useState(!1),p=()=>{o(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:i,topPerformers:d}),console.log("Recent Sales Length:",i?i.length:"null/undefined"),console.log("Top Performers:",d),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
