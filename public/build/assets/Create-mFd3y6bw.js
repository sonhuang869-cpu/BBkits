import{x as m,j as e,Q as h,V as o}from"./app-BibZwxFv.js";import{A as g}from"./AuthenticatedLayout-ZtZFmwwu.js";import"./TextInput-DiPRGPAx.js";/* empty css            */import"./transition-BDKNiHKE.js";function N(){const{data:s,setData:t,post:l,processing:i,errors:r}=m({client_name:"",total_amount:"",shipping_amount:"",payment_method:"pix",received_amount:"",payment_date:"",payment_receipt:null,notes:""}),d=a=>{a.preventDefault(),l("/sales",{onSuccess:()=>{o.success("Venda registrada com sucesso! 🎉")},onError:n=>{Object.keys(n).forEach(x=>{o.error(n[x])})}})},c={pix:"🔗",boleto:"📄",cartao:"💳",dinheiro:"💰"},p={pix:"PIX",boleto:"Boleto Bancário",cartao:"Cartão de Crédito/Débito",dinheiro:"Dinheiro"};return e.jsxs(e.Fragment,{children:[e.jsx(h,{title:"Registrar Venda"}),e.jsx("style",{children:`
