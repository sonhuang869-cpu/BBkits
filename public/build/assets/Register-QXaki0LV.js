import{x as p,j as e,Q as u,d as n,V as l}from"./app-CPboC0FU.js";import"./TextInput-D6AqKWkx.js";/* empty css            */function b(){const{data:s,setData:r,post:d,processing:i,errors:t,reset:c}=p({name:"",email:"",password:"",password_confirmation:""}),m=a=>{a.preventDefault(),d("/register",{onFinish:()=>c("password","password_confirmation"),onSuccess:()=>{l.success("Conta criada com sucesso!")},onError:o=>{Object.keys(o).forEach(x=>{l.error(o[x])})}})};return e.jsxs(e.Fragment,{children:[e.jsx(u,{title:"Cadastro - BBKits"}),e.jsx("style",{children:`
