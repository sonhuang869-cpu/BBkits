import{x,r as u,V as r,j as e,Q as h,d as o}from"./app-4EpxxEbX.js";import"./TextInput-C4n-ePya.js";/* empty css            */function b({status:a}){const{data:n,setData:c,post:d,processing:t,errors:i}=x({email:""});u.useEffect(()=>{a&&r.success(a)},[a]);const m=s=>{s.preventDefault(),d(route("password.email"),{onSuccess:()=>{r.success("Link de recuperação enviado com sucesso!")},onError:l=>{l.email&&r.error(l.email)}})};return e.jsxs(e.Fragment,{children:[e.jsx(h,{title:"Recuperar Senha - BBKits"}),e.jsx("style",{children:`
