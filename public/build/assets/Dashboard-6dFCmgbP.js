import{J as j,r as N,j as e,Q as w}from"./app-DdARGwHY.js";import{A as y}from"./AuthenticatedLayout-D9UWOA6x.js";import{S as k}from"./SalesModal-1qXK3v47.js";import{R as F}from"./RankingDisplay-Bu_Y98s1.js";import{f as r}from"./currency-nnCpYJTe.js";/* empty css            */import"./transition-Bqs--Rx5.js";import"./x-Dj6qU9wL.js";import"./createLucideIcon-4A4_Z2m-.js";function P(){var m;const{auth:l,gamification:a,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
