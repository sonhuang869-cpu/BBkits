import{x as g,r as h,V as s,j as e,Q as b,d as l}from"./app-LwMesLw5.js";import"./TextInput-CypZWNpF.js";/* empty css            */function y({status:i,canResetPassword:c}){const{data:o,setData:n,post:m,processing:d,errors:r,reset:p}=g({email:"",password:"",remember:!1});h.useEffect(()=>{i&&s.success(i)},[i]);const x=t=>{t.preventDefault(),m("/login",{onFinish:()=>p("password"),onSuccess:()=>{s.success("Login realizado com sucesso!")},onError:a=>{a.email&&s.error(a.email),a.password&&s.error(a.password)}})};return e.jsxs(e.Fragment,{children:[e.jsx(b,{title:"Entrar - BBKits"}),e.jsx("style",{children:`
