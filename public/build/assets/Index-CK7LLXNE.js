import{r as h,x as C,j as e,Q as D,t as b,V as d}from"./app-Bx6Tx5z0.js";import{A as _}from"./AuthenticatedLayout-DJ3XZbcH.js";/* empty css            */import"./transition-CV7eZ-yd.js";function V({sales:t}){const[f,i]=h.useState(!1),[s,l]=h.useState(null),{data:u,setData:j,post:x,processing:o,reset:m}=C({rejection_reason:""}),v=a=>{const r={pendente:{bg:"bg-gradient-to-r from-yellow-100 to-yellow-200",text:"text-yellow-800",border:"border-yellow-300",icon:"⏳",glow:"shadow-yellow-200"},aprovado:{bg:"bg-gradient-to-r from-green-100 to-green-200",text:"text-green-800",border:"border-green-300",icon:"✅",glow:"shadow-green-200"},recusado:{bg:"bg-gradient-to-r from-red-100 to-red-200",text:"text-red-800",border:"border-red-300",icon:"❌",glow:"shadow-red-200"},cancelado:{bg:"bg-gradient-to-r from-gray-100 to-gray-200",text:"text-gray-800",border:"border-gray-300",icon:"⚪",glow:"shadow-gray-200"},estornado:{bg:"bg-gradient-to-r from-purple-100 to-purple-200",text:"text-purple-800",border:"border-purple-300",icon:"🔄",glow:"shadow-purple-200"}},g={pendente:"Pendente",aprovado:"Aprovada",recusado:"Recusada",cancelado:"Cancelada",estornado:"Estornada"},n=r[a]||r.pendente;return e.jsxs("span",{className:`inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-bold ${n.bg} ${n.text} border-2 ${n.border} ${n.glow} shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105`,children:[e.jsx("span",{className:"text-base",children:n.icon}),g[a]]})},c=a=>new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}).format(a),w=a=>new Date(a).toLocaleDateString("pt-BR"),y=a=>{x(route("admin.sales.approve",a.id),{onSuccess:()=>{d.success("Venda aprovada com sucesso! 🎉")},onError:()=>{d.error("Erro ao aprovar venda.")}})},N=a=>{l(a),i(!0)},F=a=>{a.preventDefault(),x(route("admin.sales.reject",s.id),{onSuccess:()=>{d.success("Venda recusada com sucesso."),i(!1),l(null),m()},onError:()=>{d.error("Erro ao recusar venda.")}})},p=t.data.filter(a=>a.status==="pendente").length,k=t.data.filter(a=>a.status==="aprovado").length,E=t.data.filter(a=>a.status==="recusado").length;return e.jsxs(e.Fragment,{children:[e.jsx(D,{title:"Painel Financeiro - BBKits"}),e.jsx("style",{children:`
