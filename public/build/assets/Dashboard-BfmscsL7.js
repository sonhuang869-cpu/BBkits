import{J as j,r as N,j as e,Q as w}from"./app-A2rQyd09.js";import{A as y}from"./AuthenticatedLayout-BdvEn04U.js";import{S as k}from"./SalesModal-D2vLKRZo.js";import{R as F}from"./RankingDisplay-qJ_mCQxw.js";import{f as r}from"./currency-nnCpYJTe.js";/* empty css            */import"./transition-dwH0k4-s.js";import"./x-B3zUl4x9.js";import"./createLucideIcon-BGHLRr-I.js";function P(){var m;const{auth:l,gamification:a,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
