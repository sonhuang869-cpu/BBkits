import{J as j,r as N,j as e,Q as w}from"./app-BsZBgh-y.js";import{A as y}from"./AuthenticatedLayout-C-lRx2Rl.js";import{S as k}from"./SalesModal-DpMuHq_1.js";import{R as F}from"./RankingDisplay-BTqDii42.js";import{f as r}from"./currency-nnCpYJTe.js";/* empty css            */import"./transition-Cx7rLCGu.js";import"./x-jbjRcoaH.js";import"./createLucideIcon-DgBya6nj.js";function P(){var m;const{auth:l,gamification:a,salesData:s,recentSales:n,allMonthlySales:g,topPerformers:o}=j().props,[b,c]=N.useState(!1),u=t=>["","Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"][t]||"",v=()=>{c(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:n,topPerformers:o}),console.log("Recent Sales Length:",n?n.length:"null/undefined"),console.log("Top Performers:",o),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
