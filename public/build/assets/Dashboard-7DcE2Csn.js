import{J as g,r as b,j as e,Q as f}from"./app-BI2NWFyo.js";import{A as u}from"./AuthenticatedLayout-DNdVqtlO.js";import{S as v}from"./SalesModal-B4vq0TXK.js";import{R as m}from"./RankingDisplay-DGxt9QWh.js";import{f as t}from"./currency-Ct0iAvPU.js";/* empty css            */import"./transition-2UQVOTx2.js";import"./x-8f3j0jK1.js";import"./createLucideIcon-Bo7qp_ns.js";function B(){var c;const{auth:l,gamification:a,salesData:s,recentSales:i,allMonthlySales:x,topPerformers:d}=g().props,[h,o]=b.useState(!1),p=()=>{o(!0)};return console.log("Dashboard Props:",{salesData:s,recentSales:i,topPerformers:d}),console.log("Recent Sales Length:",i?i.length:"null/undefined"),console.log("Top Performers:",d),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
