        ...
        <>
            ...
            <div className="min-h-screen hero-gradient relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 py-8 relative z-10">
                        ...
                        <div className="flex items-center space-x-3">
                            <Link href="/">
                                <img
                                    ...
                                    alt="BBKits Logo"
                                    className="h-12 w-auto object-contain transition-all duration-300 hover:scale-105 rounded-xl bg-white p-1.5 shadow-sm"
                                />
                            </Link>
                        </div>
                        ...
                        <div className="flex items-center space-x-4">
                            {auth.user ? (
                                ...
                                <div className="flex items-center space-x-3">
                                    <Link
                                        href="/login"
                                        className="text-gray-700 hover:text-gray-900 px-5 py-2.5 rounded-xl font-medium transition duration-300 hover:bg-gray-50"
                                    >
                                        Entrar
                                    </Link>
                                    <Link
                                        href="/register"
                                        className="btn-accent px-6 py-2.5 rounded-xl font-semibold transition duration-300"
                                    >
                                        Cadastrar
                                    </Link>
                                </div>
                    ...
                    {/* Hero Section */}
                    <div className="text-center max-w-4xl mx-auto text-white pt-8 pb-16">
                        <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 hero-title leading-tight">
                            BBkits
                            <span className="block text-3xl md:text-4xl lg:text-5xl mt-4 font-medium text-white/90">
                                Sistema de Vendas Premium
                            </span>
                        </h1>

                        <p className="text-lg md:text-xl mb-12 leading-relaxed text-white/85 hero-subtitle max-w-2xl mx-auto font-light">
                    ...
                    <div className="container mx-auto px-4 py-20">
                        ...
                        <div className="grid md:grid-cols-3 gap-8 mt-12">
                            <div className="card-clean p-8 text-center group">
                                <div className="w-16 h-16 feature-icon rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition duration-300">
                                    <svg
                        ...
                        {/* Motivational Quote */}
                        <div className="mt-20 quote-section p-12 text-white text-center relative z-10">
                            <h2 className="text-2xl md:text-3xl font-bold mb-6 relative z-10">
                                "Voce nao vende bolsas. Voce entrega historias,
                                seguranca e amor."
                            </h2>
                            <div className="flex justify-center items-center gap-4 text-2xl mb-4 relative z-10">
